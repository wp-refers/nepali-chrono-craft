...
class DataConfig
{
    ...
    const YEAR_MONTH_WISE_DAYS_LENGTH = array(
    ...
    const MONTH_NE_ALIAS = array('ब‌ैशाख', 'जेठ', 'असार', 'साउन', 'भदौ', 'असोज', 'कार्तिक', 'मङ्सिर', 'पुस', 'माघ', 'फाल्गुण', 'चैत');

    const DAY_NE_ALIAS = array('अाईतबार', 'सोमबार', 'मङ्गलबार', 'बुधबार', 'बिहिबार', 'शुक्रबार', 'शनिवार');

    const EN_START_DAY = "1918-04-13";
    const EN_START_YEAR = 1918;
    const EN_END_YEAR = 2038;

    const NE_START_YEAR = 1975;
    const NE_END_YEAR = 2095;
